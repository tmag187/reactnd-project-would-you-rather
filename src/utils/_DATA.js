let users = {
  sarahedo: {
    id: 'sarahedo',
    name: 'Sarah Edo',
    avatarURL: 'http://localhost:3000/img_avatar2.png'
  },
  tylermcginnis: {
    id: 'tylermcginnis',
    name: 'Tyler McGinnis',
...
export function _saveQuestion (question) {
  return new Promise((res, rej) => {
    ...
    console.log(' ++preformatted author ' + authedUser);
    console.log(' ++preformatted optionTwo ' + question.optionTwoText);
...
export function votedFor(question, option, user) {
  let votedfor = false;
